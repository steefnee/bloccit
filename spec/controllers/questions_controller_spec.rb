  ...
  describe "GET show" do
   ...
   describe "QUESTION create" do
     ...
     it "assigns the new question to @question" do
       question :create, qustion: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
       expect(assigns(:question)).to eq Question.last
     end

     it "redirects to the new question" do
       question :create, post: {title: RandomData.random_sentence, body: RandomData.random_paragraph}
